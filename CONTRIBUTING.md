...
branches. The **RT-BE92U** (BCM6765) is retired from the roster and kept dormant.
...
Scope guardrails: the RT-BE Series (RT-BEXXU primary, plus its BCM4916 siblings; the BCM6765 RT-BE92U is dormant) only, open-source userspace only (never the proprietary blobs), and no behavior changes beyond what the hardening requires.
