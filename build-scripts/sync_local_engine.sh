...
FILES="_reaper_build_lib.sh _reaper_env.sh reaper_verify.sh reaper_stale_configure.sh reaper_dongle_id.sh
       reaper_langcheck.py reaper_csrfcheck.py reaper_static_checks.py
       verify_markers.txt _port_protect.sh gen_provenance.sh
       patch_count.sh check_symbols.sh check_ossl_consumers.sh openssl11-consumers.txt check_ovpn_pki.sh check_vts_emitter.py check_nf_parity.sh
