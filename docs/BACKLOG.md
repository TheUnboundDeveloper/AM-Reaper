...
1. **[P1] 2026-09-17 apply-window fixes — cut in v3.1.9 (2026-09-17); verified on the owner's RT-BE96U on the v3.1.8_BETA_r7 test image (Rule Status 95 green / 0 red, both retry counters 0, Gatekeeper audit clean, intercept 0 leaks). What remains is the beta's field run; the metal list below is the record of what was checked.**
