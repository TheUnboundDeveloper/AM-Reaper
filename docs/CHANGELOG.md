...
## v2.3.3 — The browser stops talking to ASUS entirely, a client-list crash fixed, and two injection paths closed
...
- Built on the **RT-BE96U** first (both variants); sibling fan-out and on-device validation to follow.
