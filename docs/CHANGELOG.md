...
## v2.1.8 — Device names unified (renames finally stick everywhere), flash-proof Traffic history, a USB disk panel, the siblings' PPPoE-1500 catch-up, and a WAN-MTU rollback

> Version note: this rung was first cut as v2.1.7; an owner field report during
> release validation caught the WAN-MTU regression described below, so the rung
> was respun as v2.1.8 with the rollback included. v2.1.7 was never published.
