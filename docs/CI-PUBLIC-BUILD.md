...
`build-scripts/port_sibling_v2.sh` (a newer sixth model, **RT-BE92U** / BCM6765, exists
on its own branch but is **not yet in this CI matrix** — it is built locally and ships as
experimental prereleases) — which computes `git diff be96u-only <branch>`
