...
A security-hardened, **de-clouded** single-model fork of **Asuswrt-Merlin** focused exclusively on the **ASUS RT-BE96U** (WiFi 7 / Broadcom BCM4916), firmware line **3006.102.x**. Current version **v1.4.1** — see [`CHANGELOG.md`](CHANGELOG.md) and [`RELEASE-NOTES.md`](RELEASE-NOTES.md).
...
- **Branding:** `reaper`. The build version reads `RT-BE96U 3006.102.8_Reaper_v<X>` (e.g. `…_Reaper_v1.4.1`).
