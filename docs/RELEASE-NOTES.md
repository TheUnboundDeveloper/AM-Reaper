...
**Firmware:** `3006.102.8_Reaper_v2.3.3` -- current head, **RT-BE96U only so far** (both variants); sibling fan-out and on-device validation pending. Prior full-fleet releases: **v2.3.2**, **v2.3.0**, **v2.2.6**.
...
> **v2.3.3** is RT-BE96U-only so far, both variants, sibling fan-out pending metal.
